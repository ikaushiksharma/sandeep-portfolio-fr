...
const Footer = (props: Props) => {
  return (
    <footer className="md:min-h-[50vh] flex flex-col justify-center items-center h-full w-full 2xl:px-16 xl:px-16 md:px-12 sm:px-2 px-4 max-md:pt-10">
      <div className="flex w-full flex-col">
        <div className="flex max-md:flex-col w-full flex-auto">
          <h1 className="font-semibold flex-auto text-4xl uppercase">
            Sandeep
          </h1>
          <VR classes="h-[30vh]" />
          ...
          <div className="flex max-lg:items-center justify-evenly pt-4 lg:justify-end space-x-4 flex-auto">
            <Icon
              svg={
                <svg
                  width="16"
        ...
        <div className="flex max-sm:text-xs sm:text-sm  md:text-base w-full pt-10 max-md:pb-10 flex-row items-center justify-between">
          <p>Copyright © 2023 Sandeep. All Rights Reserved.</p>
          <p>Privacy Policy</p>
        </div>
      </div>
    </footer>
...
const Icon = ({ svg, link }: { svg: React.ReactNode; link: string }) => (
  <Link href={link}>
    <button className="p-3 aspect-square rounded-full bg-dark-secondary">
      {svg}
    </button>
  </Link>
);
